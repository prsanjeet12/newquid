...
const UploadBulkLeads: React.FC<{ open: boolean; onClose: () => void }> = ({ open, onClose }) => (
  <Modal open={open} onClose={onClose} title="Upload Bulk Leads">
...
export default UploadBulkLeads;
